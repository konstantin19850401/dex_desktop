...
namespace DEXOffice
{
    public partial class MultiIgnorRegForm : Form
    {
        DEXToolBox toolbox;
        public static List<string> selectedIdReg = new List<string>();
        public MultiIgnorRegForm()
        {
            InitializeComponent();
            ...
            */
            ...
            //reg.Add("400-404,волгогр", "Волгоградская область"); //Ростовская, Ростовская область
            reg.Add("350-354,Краснодар", "Краснодарский край"); // Краснодарский, Краснодарский край
            reg.Add("355-357,СТС", "Ставропольский край"); //Ставропольский край, СТАВРОПОЛЬСКИЙ КРАЙ
            reg.Add("385,Адыгея", "Республика Адыгея (Адыгея)"); // Адыгея республика, Адыгея
            reg.Add("367-368,РД", "Республика Дагестан"); //Дагестан республика,Дагестан
            reg.Add("386,Ингушетия", "Республика Ингушетия"); //Ингушетия республика
            reg.Add("360-361,КБР", "Кабардино-Балкарская республика"); //Кабардино-балкарская республика
            //reg.Add("358-359,Калмыкия", "Республика Калмыкия"); //Калмыкия республика
            reg.Add("369,КЧР", "Карачаево-Черкесская республика"); //Карачаево-черкесская республика
            reg.Add("362-363,РСО", "Республика Северная Осетия-Алания"); //Северная осетия-алания республика
            //reg.Add("364-366,чечен", "Чеченская республика"); //Чеченская республика
