...
{
    public partial class FPlansGFMain : Form
    {
        ...
        {
            da = ((IDEXMySqlData)toolbox).getDataAdapter("select * from `um_plans_gf`");
        ...
        public void RefreshPlans()
        {
            ...
            if (t != null)
            {
                ...
                dgvPlans.Columns.AddRange(new System.Windows.Forms.DataGridViewColumn[] {
                        plan_id, title, allowed, allow_m});
                plan_id.DataPropertyName = "plan_id";
                title.DataPropertyName = "title";
                allowed.DataPropertyName = "allowed";
                allow_m.DataPropertyName = "allow_m";
        ...
        private void bEdit_Click(object sender, EventArgs e)
        {
            ...
            FPlansGFEd PlansEd = new FPlansGFEd();
