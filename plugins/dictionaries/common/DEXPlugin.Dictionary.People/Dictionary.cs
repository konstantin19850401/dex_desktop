...
namespace DEXPlugin.Dictionary.People
{
    public class Dictionary: IDEXPluginDictionary
    {
        public string ID
        {
            get
            {
                return "DEXPlugin.Dictionary.People";
            }
        }
        public string Title
        {
        ...
        public string Description
        {
            get
            {
                return "Справочник записей о персональных сведениях абонентов";
            }
        }
        ...
        public void Startup(Object toolbox)
        {
            ...
            r.AddRightsItem(ID + ".access", "Доступ к справочнику абонентов");
        }
        ...
        public void ShowDictionary(Object toolbox)
        {
            ...
            {
                FPeopleMain main = new FPeopleMain(toolbox);
                main.ShowDialog();
                main = null;
            ...
            {
                MessageBox.Show("У пользователя отсутствуют права доступа к справочнику абонентов");
            }
