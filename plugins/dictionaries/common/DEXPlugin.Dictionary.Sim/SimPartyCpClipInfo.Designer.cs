...
{
    partial class SimPartyCpClipInfo
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            this.label1.Text = "В указанной партии имеются карты, помеченные как проданные или  распределенные на" +
                " отделения.\r\n\r\n";
            // 
            // button1
            // 
            ...
            this.button1.Text = "Загрузить только свободные карты";
            ...
            this.button2.Text = "Загрузить все карты";
