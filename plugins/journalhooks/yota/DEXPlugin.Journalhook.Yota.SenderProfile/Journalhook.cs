...
namespace DEXPlugin.Journalhook.Yota.SenderProfile
{
    public class Journalhook : IDEXPluginJournalhook
    {
        public string ID
        {
            get
            {
                return "DEXPlugin.Journalhook.Yota.SenderProfile";
            }
        }
        public string Title
        {
            get
            {
                return "Профиль экспорта договра Yota";
            }
        }
        ...
        public string Description
        {
            get
            {
                return "Устанавливает профиль экспорта выделенному документу Yota";
            }
        }
        ...
        public void InitReflist(object toolbox)
        {
            ...
            DataTable t = d.getQuery("select * from `yota_profiles` order by pname");
        ...
        {
            if (DocType.Equals("DEXPlugin.Document.Yota.Contract", StringComparison.InvariantCultureIgnoreCase) &&
        ...
        public bool RunFunctionForDocument(string FunctionName, string SubFunctionName, string docId, IDEXDocumentData doc, out bool docChanged)
        {
            ...
            try
            {
                if (FunctionName.Equals("changeprofile") && docId.Equals("DEXPlugin.Document.Yota.Contract") &&
                    journalType == DEXJournalType.JOURNAL &&
