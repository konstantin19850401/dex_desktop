        ...
        private void bReport_Click(object sender, EventArgs e)
        {
            ...
            if (er.Equals(""))
            {
                ...
                if (er.Equals(""))
                {
                    ...
                    if ( !cbDevidePeriod.Checked )
                    {
                         rv.LocalReport.ReportEmbeddedResource = "DEXPlugin.Report.Yota.Sverka.Sverka.rdlc";
                    }
                    else
                    {
                        //rv.LocalReport.ReportEmbeddedResource = "DEXPlugin.Report.Common.Sverka.SverkaDevide.rdlc";
                        rv.LocalReport.ReportEmbeddedResource = "DEXPlugin.Report.Yota.Sverka.SverkaDevideTest.rdlc";
                    }                    

                   
                    //rv.LocalReport.ReportPath = "DEXPlugin.Report.Yota.Sverka.Sverka.rdlc";
